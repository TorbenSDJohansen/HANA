...
(Almost) pure copy from official torchvision implementation.

Classifier is disabled. That is, it still exists as an asstribute but it is NOT
classed in the forward pass.

The purpose of this script is to use these models as starting points for
training other models (such as sequence estimators), using pretrained resnets.

CONTAINS: resnet, resnext, wrn models.

FURTHER: Added weakly supervised learning (WSL) models, see
https://github.com/facebookresearch/WSL-Images
This has been modified only slightly.
"""
...
model_urls = {
    ...
    'resnext101_32x32d_wsl': 'https://download.pytorch.org/models/ig_resnext101_32x32-e4b90b00.pth',
    'resnext101_32x48d_wsl': 'https://download.pytorch.org/models/ig_resnext101_32x48-3e41cc8a.pth',
}
